   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package general
       ...
       (general-define-key
        ...
        "s-d r" 'delete-trailing-whitespace

        ;; combination with super+k
        "s-k s-t" 'z/epoch-unix-to-time
        "s-k t" 'z/epoch-unix-to-time
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (defun z/epoch-unix-to-time(start end)
       ...
       (let
         ...
         (message "Result: %s equal to %s"
                  str-orig
                  (format-time-string "<%Y-%m-%d %a %H:%M:%S %z>" (seconds-to-time (string-to-number str)))
                  ;; (format-time-string "<%Y-%m-%d %a %H:%M:%S %z>" (seconds-to-time (string-to-number str-short)))
                  )
         ))
