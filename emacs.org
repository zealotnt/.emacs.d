   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package general
       ...
       (general-define-key
        ...
        "fyL" 'w/projectile-copy-relative-file-path-with-line
       ...
       (general-define-key
        ...
        "s-k s-f" 'w/projectile-copy-relative-file-path
        "s-k s-l" 'w/projectile-copy-relative-file-path-with-line
...
** Helm config
   #+BEGIN_SRC emacs-lisp
     ...
     (defun w/projectile-copy-relative-file-path-with-line ()
       "Copy and show the file path relative to project root."
       (interactive)
