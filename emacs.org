   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package general
       ...
       (general-define-key
        ...
        "s-k s-f r"   'w/projectile-copy-relative-file-path
        "s-k s-f s-r" 'w/projectile-copy-relative-file-path
        "s-k s-f a"    'z/absolute-path
        "s-k s-f s-a"  'z/absolute-path
        "s-k s-f l"   'w/projectile-copy-relative-file-path-with-line
        "s-k s-f s-l" 'w/projectile-copy-relative-file-path-with-line
