   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package general
       ...
       (general-define-key
        ...
        "C-w -" '((lambda () (interactive) (evil-window-decrease-height 15)) :which-key "window-increase-height")
        "C-w >" '((lambda () (interactive) (evil-window-increase-width 15)) :which-key "window-increase-height")
        "C-w <" '((lambda () (interactive) (evil-window-decrease-width 15)) :which-key "window-increase-height")
