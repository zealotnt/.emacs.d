   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package general
       ...
       (general-define-key
        ...
        "fyY" 'w/projectile-copy-relative-file-path
        ...
        "w-" '((lambda () (interactive) (split-window-below) (other-window 1)) :which-key "split-window-below")
        "wv" '((lambda () (interactive) (split-window-right) (other-window 1)) :which-key "split-window-right")
       ...
       (general-define-key
        ...
        "C-w v" '((lambda () (interactive) (split-window-right) (other-window 1)) :which-key "split-window-right")
        "C-w s" '((lambda () (interactive) (split-window-below) (other-window 1)) :which-key "split-window-below") "tab" 'evil-avy-goto-word-or-subword-1
        )
       (general-define-key
        :states '(normal visual emacs)
        ...
        "s-b" 'toggle-maximize-buffer

        ;; navigation
        "M-[" 'evil-jump-backward
        "M-]" 'evil-jump-forward
        "<M-return>" 'find-my-tag
        "<s-return>" 'find-my-tag

        ;; combination with super+s
        "s-k s-s" 'neotree-project-dir-toggle
        "s-k s-w" 'toggle-truncate-lines
        "s-k s-p" 's/show-buffer-file-path
        "s-k s-i" 's/show-buffer-file-name
        "s-k s-r" 'sync-config

        "s-1" 'customize ;;before, it is "s-,"
        "s-0" '(lambda () (interactive) (neotree-project-dir-toggle) (neotree-quick-look))
        "s-, s-," 'z/open-emacs-config-file
        "s-. s-." 'z/open-emacs-config-file

        ;; 3 key stroke with super
        "<C-s-268632087>" 'delete-other-windows
        "<C-s-268632079>" 'w/projectile-switch-project ;; super+ctrl+p
        "<C-s-268632080>" 'w/projectile-switch-project ;; super+ctrl+o
        )
       (general-define-key
        :states '(normal visual insert emacs)
...
** Setup editor config
   #+BEGIN_SRC emacs-lisp
     ...
     (defun w/setup-font-and-window ()
       (progn
         ;;Font size 13pt
         (set-face-attribute 'default nil :font "Inconsolata Nerd Font Mono-14" )
         (menu-bar-mode -1)
...
** Helm config
   #+BEGIN_SRC emacs-lisp
     ...
     (defun w/projectile-copy-relative-file-path ()
...
** Neotree config
   #+BEGIN_SRC emacs-lisp
    ...
    '(neo-dir-link-face ((t (:foreground "deep sky blue" :slant normal :weight bold :height 120 :family "Inconsolata Nerd Font Mono"))))
    '(neo-file-link-face ((t (:foreground "White" :weight normal :height 120 :family "Inconsolata Nerd Font Mono"))))
    )
