   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package evil
       ...
       (with-eval-after-load "dired" ;"dired mapping"
         ...
         ;; H: previously: dired-do-hardlink
         (define-key dired-mode-map (kbd "H") #'evil-digit-argument-or-evil-beginning-of-line)
         ;; L: previously: dired-do-load
         (define-key dired-mode-map (kbd "C-o") #'evil-jump-backward) ; previously: dired-display-file
         (define-key dired-mode-map (kbd "L") #'evil-end-of-line)
         (define-key dired-mode-map (kbd "q") #'keyboard-quit)
         (define-key dired-mode-map (kbd "C-g") #'dired-do-redisplay)
         ...
         (define-key dired-mode-map (kbd "<s-return>") #'z/open-using-desktop-association)
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package neotree
       ...
       (with-eval-after-load 'neotree
         ...
         (evil-define-key 'normal neotree-mode-map (kbd "<s-return>") 'z/open-using-desktop-association)
